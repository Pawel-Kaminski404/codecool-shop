...
namespace Codecool.CodecoolShop
{
    public class Startup
    {
        ...
        private void SetupInMemoryDatabases()
        {
            ...
            productDataStore.Add(new Product { Name = "Lenovo IdeaPad Mix 700", DefaultPrice = 479.0m, Currency = "USD", Description = "Keyboard cover is included. Fanless Core m5 processor. Full-size USB ports. Adjustable kickstand.", ProductCategory = tablet, Supplier = lenovo });
